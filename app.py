...
st.markdown("""
This chatbot is designed to help you **navigate the Growing Sustainably Toolkit**.  
...
With this chatbot, you can move from **simple recall questions** (e.g., *“What is the purpose of the toolkit?”*) to **applied, context-based questions** (e.g., *“How do I use the income statement template to plan for the next year?”*).  

Think of it as your **go-to companion** — helping you quickly locate relevant sections, clarify concepts, and apply the toolkit to your own context.  
""")

with st.chat_message("assistant"):
    st.markdown("""
👋 Welcome! I’m the **GSF Toolkit Assistant**.  
I’m here to help you explore and apply the **Growing Sustainably Toolkit**.  
...
- *“Can you explain the Makasi or aeioTU case studies?”*  
""")
